  ...
  <div class="row g-4">
    <div class="col-lg-6">
      <div class="card shadow-sm h-100"><div class="card-body">
        <h4 class="h5">Admission Process</h4>
        <ol><li>Fill online/offline form</li><li>Document verification</li><li>Merit list publication</li><li>Fee submission</li></ol>
        <h4 class="h5">Eligibility Criteria</h4><p>As per university norms for respective programs.</p>
        <h4 class="h5">Important Dates</h4><p>Form Open: 01 June | Last Date: 31 July | Merit List: 10 August</p>
        <h4 class="h5">Documents Required</h4><ul><li>10th/12th marksheets</li><li>Aadhaar</li><li>Transfer certificate</li><li>Photographs</li></ul>
      </div></div>
    </div>
    <div class="col-lg-6">
